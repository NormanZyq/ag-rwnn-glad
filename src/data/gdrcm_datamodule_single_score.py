...
from src.data.components.ablation_dataset_single_score import AnomalyAwareGDRCDataset, EnhancedSequenceBasedAnomalyAwareDataset
...
# 修改数据模块以使用增强版本的数据集
class EnhancedGDRCMDataModuleAblSingleScore(GDRCMDataModule):
